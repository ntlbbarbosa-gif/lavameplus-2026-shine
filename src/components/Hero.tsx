          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <span className="text-accent font-semibold text-sm">
                🔥 Hoje: Sofá Retrátil (até 2,00m) por R$150
              </span>
            </motion.div>
            ...
            >
              Seu Estofado Está{" "}
              <span className="text-gradient-coral">Manchado</span>, Com Cheiro
              Forte ou Cheio de{" "}
            ...
            >
              Recupere o conforto e a higiene com limpeza a seco profissional!
              Removemos sujeira profunda, manchas, odores e ácaros —{" "}
              <strong className="text-foreground">
                sem molhar e com resultado na hora.
              </strong>
            </motion.p>
            ...
            >
              {[
                ...
                { icon: Clock, text: "Secagem rápida" },
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-foreground">Na Hora!</p>
                </div>
              </div>
            </motion.div>
